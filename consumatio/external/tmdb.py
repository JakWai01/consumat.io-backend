...
class Tmdb():
    ...
    def get_movie_details(self: object, movie_id: int) -> dict:
        ...
        """
        logger.info("Request:'movie_details' transmitted to database")
    ...
    def get_movie_providers(self: object, movie_id: int, country: str) -> dict:
        ...
        """
        logger.info("Request:'movie_providers' transmitted to database")
    ...
    def get_movie_images(self: object, movie_id: int) -> dict:
        ...
        """
        logger.info("Request:'movie_images' transmitted to database")
    ...
    def get_movie_credits(self: object, movie_id: int) -> dict:
        ...
        """
        logger.info("Request:'movie_credits' transmitted to database")
    ...
    def get_tv_details(self: object, tv_id: int) -> dict:
        ...
        """
        logger.info("Request:'tv_details' transmitted to database")
    ...
    def get_tv_providers(self: object, tv_id: int, country: str) -> dict:
        ...
        """
        logger.info("Request:'tv_providers' transmitted to database")
    ...
    def get_tv_images(self: object, tv_id: int) -> dict:
        ...
        """
        logger.info("Request:'tv_images' transmitted to database")
    ...
    def get_tv_credits(self: object, tv_id: int) -> dict:
        ...
        """
        logger.info("Request:'tv_credits' transmitted to database")
    ...
    def get_season_details(self: object, tv_id: int,
        ...
        """
        logger.info("Request:'season_details' transmitted to database")
    ...
    def get_season_images(self: object, tv_id: int,
        ...
        """
        logger.info("Request:'season_images' transmitted to database")
    ...
    def get_episode_details(self: object, tv_id: int, season_number: int,
        ...
        """
        logger.info("Request:'episode_details' transmitted to database")
    ...
    def get_episode_images(self: object, tv_id: dict, season_number: int,
        ...
        """
        logger.info("Request:'episode_images' transmitted to database")
    ...
    def get_search(self: object, keyword: str) -> dict:
        ...
        """
        logger.info("Request:'search' transmitted to database")
    ...
    def get_popular_movies(self: object, country: str) -> dict:
        ...
        """
        logger.info("Request:'popular_movies' transmitted to database")
    ...
    def get_popular_tv(self: object) -> dict:
        ...
        """
        logger.info("Request:'popular_tv' transmitted to database")
